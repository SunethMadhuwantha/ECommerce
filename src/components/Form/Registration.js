...
function Registration() {
  ...
  // const [isCorrectPassword, setIsCorrectPaasword] = useState(true);
  ...
  //     setIsCorrectPaasword(false);
  //   }
  //   // if all fields are valid, then call axios
  //   if (nameLengthError==false && invalidEmail==false && isCorrectPassword==true) 
    // comment below line
    // alert("validation success");
    if(name.length<6){
      alert("Name shold be more than 6 characters.")
    }
      ...
      >
        ...
        <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
          ...
          <p
            ...
            className="mb-8 text-2xl font-extrabold leading-6 text-gray-800"
          >
            Create your account
          </p>
          ...
          <div>
            ...
            {/* {nameLengthError ? (
              <p class="text-red-500 text-xs italic">
                User name must be between 6 to 20 letters
              </p>
            ) : (
              ""
            )} */}
          ...
          <div className="mt-6  w-full">
            ...
            >
              ...
              {!isCorrectPassword ? (
                <p class="text-red-500 text-xs italic">
                  Password should contain uppercase letter, lowercase letter,
                  number and atleast 8 characters.
                </p>
              ) : (
                ""
              )} */}
          ...
          <div className="mt-8">
            ...
            <p
              className="text-sm mt-4 font-medium leading-none text-gray-500"
