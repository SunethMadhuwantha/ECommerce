...
export default function Content() {
    return (
        <>
            <div className="pt-5 ml-8 py-20 2xl:px-0 lg:px-12 px-4 2xl:mx-auto 2xl:container bg-gray-50" style={{ height: 1000 }}>
                <div className="md:flex items-center justify-between w-full bg-gray-50">
                    ...
                    <div className="xl:w-4/6 md:w-1/2 w-full xl:pl-48">
                        ...
                        <div className="w-full">
                            <img src="https://www.10wallpaper.com/wallpaper/medium/1601/European_Street_Girls_Beauty_Photo_HD_Wallpaper_medium.jpg" alt="Purple flowers on a book" className="md:w-full sm:w-1/2 w-full" />
